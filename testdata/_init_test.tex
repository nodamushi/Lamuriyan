...
\newcommand{\css}[2][]{%
  ...
  \disableparagraph%
  \box[rel=stylesheet,type=text/css]{link}{\setAttr{href}{#2}\setAttrs{#1}}%
  \push\cssfiles{#1}%
  \resetparagraph\oldparagraph%
  \egroup}
\newcommand{\charset}[1]{
  \setgprop{charset}{#1}%
  \box{meta}{\setAttr{content}{text/html;charset=#1}\setAttr{http-equiv}{Content-Type}}}
...
\newcommand{\js}[2][]{%
  ...
  \let\oldparagraph\useparagraph%
  \disableparagraph%
  \box[type=text/javascript]{script}{\setAttrs{#1}\setAttr{src}{#2}  }%
  \resetparagraph\oldparagraph%
  \egroup}
...
\def\alink#1#2{\inline{a}{\setAttr{href}{#1}#2}}
...
\def\@blockquote@makecite{%
  ...
  \let\oldparagraph\useparagraph%
  \disableparagraph%
  \box{cite}{\@blockquote@makeurl\@blockquote@title}%
  \resetparagraph\oldparagraph%  
  \fi}
